...
const INPUTS: &[(&str, &[u8])] = &[
    ("moordread", include_bytes!("../builds/Castle_MoorDread_-_FFA.brs")),
    ("city", include_bytes!("../builds/Brickadia_City.brs")),
    ("legfast_qa", include_bytes!("../builds/LEGFAST_QA.brs")),
    ("halloweenfest", include_bytes!("../builds/HalloweenFest_Spirit.brs")),
